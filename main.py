...
# Now we have to Load the pre-trained models
...
# now we have to Set up caption generation parameters
max_length = 16
num_beams = 4

# now we have to Define the  function to generate captions for an image
def generate_captions(image_path, num_captions):
    try:
        ...
        # now we have to Extract image features and generate captions
        ...
        # Now we have to Update all  GUI with generated captions
...
def select_image():
    ...
    # Generate captions for selected image
